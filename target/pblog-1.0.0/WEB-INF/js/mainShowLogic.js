...
var loadTitleDictumDInfoAjax = function () {
    $.ajax({
        method: 'POST',
        url: '/pb/data/getTitleDictumDInfo',
        // data: sendDataObj,
        dataType: 'text',
...
var requestUserInfo = function () {
    ...
    loadAjax = $.ajax({
        method: 'POST',
        url: '/pb/userInfo/userInfoRequire',
        dataType: 'text',
        success: function (data) {
            if (data === FAILURE) {
...
$("#leisureArticle_span").on("click", function () {
    ...
    loadArticleData('/pb/data/getLeisureArticles', theLeisureCurrentPageIndex);
});
...
$("#professionalArticle_span").on("click", function () {
    ...
    loadArticleData('/pb/data/getProfessionalArticles', theProfessionalCurrentPageIndex);
});
//用于加载文章的逻辑操作
                    ...
                    if (judgeNumber % 4 === 0) {
                        ...
                        //文章缩略图不存在时随机在四张指定的图片中填补
                            ...
                            switch (Math.floor(Math.random() * 4)) {
                                case 0:
                                    img.setAttribute('src', "/pb/imgs/smile_icon_0.png");
                                    break;
                                case 1:
                                    img.setAttribute('src', "/pb/imgs/smile_icon_1.png");
                                    break;
                                case 2:
                                    img.setAttribute('src', "/pb/imgs/smile_icon_2.png");
                                    break;
                                case 3:
                                    img.setAttribute('src', "/pb/imgs/smile_icon_3.png");
                                    break;
                            }
                        }
                        //文章简短内容
                            ...
                            editButton.onclick = function () {
                                ...
                                let modifyFunc = function () {
                                    modifyArticleContentAjax = $.ajax({
                                        method: 'POST',
                                        url: '/pb/article/loadArticleContentOfHtml',
                                        ...
                                        success: function (data) {
                                            ...
                                            if (data === SUCCESS) {
                                                editButton.canClick = true;
                                                window.location.href = '/pb/owner/ownerModifyArticle.html';
                                            } else {
                            ...
                            deleteButton.onclick = function () {
                                if (this.canClick) {
                                    ...
                                    let deleteArticleAjaxFunc = function (articleLocationLink) {
                                        $.ajax({
                                            method: 'POST',
                                            url: '/pb/data/deleteAppointArticle',
                                            data: {
        ...
        span.onclick = function (e) {
            ...
            switch (choiceModuleType) {
                case choiceLeisureArticleModule:
                    loadArticleData('/pb/data/getLeisureArticles', this.innerHTML);
                    break;
                case choiceProfessionalArticleModule:
                    loadArticleData('/pb/data/getProfessionalArticles', this.innerHTML);
                    break;
    ...
    switch (mChoiceModuleType) {
        case choiceLeisureArticleModule:
            if (previous)
                ...
                pageNum = ++theLeisureCurrentPageIndex;
            loadArticleData('/pb/data/getLeisureArticlePageNumber', pageNum);
            break;
        case choiceProfessionalArticleModule:
            if (previous)
...
var showOrHidePagingDiv = function (choiceModuleType) {
    ...
    switch (choiceModuleType) {
        case choiceLeisureArticleModule:
            url = '/pb/data/getLeisureArticlePageNumber';
            break;
        case choiceProfessionalArticleModule:
            url = '/pb/data/getProfessionalArticlePageNumber';
            break;
        case choicePhotoModule:
            url = '/pb/data/getPicturesTotalNumber';
            break;
        case choiceDocModule:
            url = '/pb/data/getDocsTotalNumber';
            break;
    }
    loadModuleDataEleTotalNumberFunc(url, choiceModuleType);
};
