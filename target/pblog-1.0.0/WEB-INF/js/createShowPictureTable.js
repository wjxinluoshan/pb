...
var createImgTag = function (urlIndex) {
    for (; urlIndex < choosedPicturesUrlFromLocal.length; urlIndex++) {
        ...
        magnifyImg.setAttribute('src', '/pb/imgs/magnify_icon.png');
        ...
        magnifyImg.onclick = function () {
            let magnifiedImgDiv = $('<div class="magnify_img_div" id="magnify_img_div">' +
                '<div  style="background: #00A2E8;height: max-content"><img  id="failure_img" style="width: 5%" src="/pb/imgs/failure_icon.png" /><img  id="magnify_img" style="width: 5%;margin-left: 40%;;padding: 0" src="/pb/imgs/magnify_icon.png" /><img  id="shrink_img" style="width: 4%;padding: 0;margin-top: 0" src="/pb/imgs/shrink_icon.png" />' +
                '</div>' +
