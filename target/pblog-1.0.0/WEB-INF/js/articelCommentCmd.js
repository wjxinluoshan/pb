        ...
        fromCommentTableDataArr.forEach(function (commentData, index) {
            ...
            if (id !== rId) {
                ...
                $('#show_comment_area_div').append($(' <div class="part_of_comment_div">\n' +
                    '        <img class="commenter_img" id="commenter_img_' + index + '" src="/pb/imgs/comment_icon.png"/>\n' +
                    ...
                    '            </p>\n' +
                    '        <img class="comment_reply_img" id="comment_reply_img_' + index + '" src="/pb/imgs/reply_icon.png"/>\n' +
                    '    </div>'));
                //绑定相应事件和相关赋值操作
